    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JwtTokenRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JwtTokenRecords_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JwtTokenRecords_Id",
                table: "JwtTokenRecords",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_JwtTokenRecords_UserId",
                table: "JwtTokenRecords",
                column: "UserId");
